	...
	C80.2,0,80.1,0,80,0z"
        ...
        <div className="u-align-left u-container-style u-grey-10 u-group u-group-1">
          <div className="u-container-layout u-valign-top-lg u-valign-top-xl u-container-layout-1">
            ...
            Our delivery service guarantees fast, reliable, and efficient order fulfillment, with real-time tracking, updates, and seamless communication, ensuring customers receive their food fresh and on time at their doorstep.
            </p>
          </div>
        </div>
        <div
