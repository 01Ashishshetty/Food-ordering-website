...
function Section1() {
  return (
	...
	c0,49.1,58.2,47.8,76.2,68.5c38.8,44.7,92.8,8.2,79.3-40.3C148.1,73.2,155.9,50.6,157.4,45.5z"
        ...
        Welcome to The Pizza Villa! Enjoy homemade pizza with fresh, 
        high-quality ingredients. Whether it's a classic Margherita or one of our specialties, 
        every bite is a delight. Come savor delicious meals in a warm, inviting atmosphere perfect for pizza lovers.
        </p>
        <Link
          to="/menu"
